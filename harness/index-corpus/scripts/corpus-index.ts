...
import { parseTranscript, transcriptDuration, type Transcript } from "../../../skills/_shared/lib/transcript.ts";
import {
...
/** Write the index atomically (tmp + rename), the harness/feed/src/app.ts pattern. */
